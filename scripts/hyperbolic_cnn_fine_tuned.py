...
from wbc_classification.models.hyperbolic_cnn import HyperbolicClassifier
...
class FinetuneConfig:
    ...
    feature_clip_norm: Optional[float] = None
    img_size: int = 224
    workers: int = DEFAULT_DATALOADER_WORKERS
    seed: int = 42
...
def train(
    ...
    if cfg.out_dir:
        ...
        run_config_path = os.path.join(cfg.out_dir, "resolved_config.json")
    ...
    model = HyperbolicClassifier(
        ...
        feature_clip_norm=cfg.feature_clip_norm,
    ).to(device)
